...
Dieses Beispiel ist für graphische Darstellungen.
Es zeigt auch, dass berechnete Variablen wie BMI beim imputieren Probleme verursachen können. 
...
*Details
Random sample of 10% from the cross-sectional data used to construct the Dutch growth references
1997. Variables gen and phb are ordered factors. reg is a factor.
