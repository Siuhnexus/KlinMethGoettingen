...
wide == Daten jeder Person stehen in einer Zeile long == Daten der einzelnen Messzeitpunkte stehen in einer Zeile, d.h. jede Person hat mehrere Zeilen

### Warum ist es wichtig Daten ins long Format zu übertragen?

Nur so kann jede der Zeitpunkt der Messung ein Prädiktor sein kann. Jeder Prädiktor muss eine Variable in einer Spalte sein =\> damit kommt jeder Person zwei Mal vor, d.h. in zwei Zeilen
