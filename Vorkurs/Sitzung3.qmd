...
## Graphiken für zwei kontinuierliche Variablen
...
## Graphiken für kategorialen Praediktor und kontinuierliches Kriterium

### Graphiken für Rohdaten
...
### Graphiken für Mittelwerte in verschiedenen Gruppen
...
descriptives <- describeBy(hwy ~ cyl, mat = TRü, data = mpg)
...
# Noch hübscher, wenn etwas gegeneinander verschoben
